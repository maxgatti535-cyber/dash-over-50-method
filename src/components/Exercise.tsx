            ...
            <div className="space-y-4">
                ...
                <div className="bg-surface p-5 rounded-xl shadow-sm shadow-shadowSoft border border-brandPrimaryDark">
                    ...
                    <div className="mt-4 pt-3 border-t border-border text-center">
                        <button
                            onClick={() => onNavigateToCoach(`I need advice on the ${activeTab} exercise routine: ${levelData.exercises.map(e => e.name).join(', ')}`)}
                            className="text-brandPrimary font-bold hover:underline text-lg"
                        >
                            Ask Coach about these exercises
                        </button>
                    </div>
                </div>
